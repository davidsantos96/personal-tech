...
export const studentWorkouts: StudentWorkout[] = [
    ...
    },
    {
        ...
        exercises: [
            ...
            { id: 7, name: 'Prancha', series: 3, reps: '45s', weight: '-', rest: 45, estimatedExecutionTime: 45, notes: 'Manter abdômen contraído', completed: false, gifUrl: 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Plank/0.jpg' },
        ],
    },
];
